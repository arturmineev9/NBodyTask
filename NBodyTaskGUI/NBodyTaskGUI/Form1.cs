...
namespace NBodyTaskGUI
{
    public partial class Form1 : Form
    {
        ...
        {
            /*if (IsCorrectNum(tbBodiesCount.Text, BodiesAcceptableParams.minBodiesNum, BodiesAcceptableParams.maxBodiesNum))
            {
            ...
            if (IsCorrectNum(tbBodyMass.Text, BodiesAcceptableParams.minBodyMass, BodiesAcceptableParams.maxBodyMass))
            {
            ...
            if (IsCorrectNum(tbDeltaTime.Text, BodiesAcceptableParams.minDeltaTime, BodiesAcceptableParams.maxDeltaTime))
            {
            ...
            if (IsCorrectNum(tbThreadsNum.Text, BodiesAcceptableParams.minThreadsNum, BodiesAcceptableParams.maxThreadsNum))
            {
        ...
        {
            // Загрузка DLL
            realizationAssembly = Assembly.LoadFile(@"C:\Users\serge\source\repos\NBodyTaskRealisation\NBodyTaskRealisation\obj\Debug\net8.0\NBodyTaskRealisation.dll");
